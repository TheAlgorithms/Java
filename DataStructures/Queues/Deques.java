 ...
 * double ended queue pronounced "deck" and sometimes referred to as a
 * head-tail linked list. A deque is a data structure based on a doubly linked
 * list, but only supports adding and removal of nodes from the beginning and
 * the end of the list.
 *
