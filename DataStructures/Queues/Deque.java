        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    if (check == x)
                        System.out.println(x + "Has been successfully added to the rear");
                    else
                ...
                case 2:
                    ...
                    if (x == -1)
                        ...
                        System.out.println(x + "Has been successfully removed from the front");
                ...
                case 3:
                    ...
                    if (x == -1)
                        ...
                        System.out.println(x + "Has been successfully removed from the rear");
                ...
                case 4:
                    ...
                    if (check == x)
                        System.out.println(x + "Has been successfully added to the Front");
                    else
                        System.out.println("Overflow");
