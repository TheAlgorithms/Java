...
*before the transpose and after the transpose.
* <p>
   ...
   */
		 Scanner sc = new Scanner(System.in);
			...
			*/ 
			...
			/*
			*Print matrix after the tranpose in proper way
			* Transpose means Interchanging of rows wth column so we interchange the rows in next loop
			*Thus at last matrix of transpose is obtained through user input...
			*/ 
