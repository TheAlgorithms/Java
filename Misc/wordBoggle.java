...
{
    //O(nm * 8^s + ws) time where n=width of boggle board, m=height of boggle board, s=length of longest
    // word in string array, w= length of string array, 8 is due to 8 explorable neighbours
    // O(nm + ws) space
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(boggleBoard(new char[][]{
                ...
                {'N', 'O', 'T', 'R', 'E', '_', 'P'},
                {'x', 'x', 'D', 'E', 'T', 'A', 'E'}},
                new String[] {"this", "is", "not", "a", "simple", "test", "boggle", "board", "REPEATED", "NOTRE_PEATED"}));
    }
