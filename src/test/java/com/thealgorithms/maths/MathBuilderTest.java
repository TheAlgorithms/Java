...
class MathBuilderTest {
    ...
    @Test
    void simpleMath() {
        double result = new MathBuilder.Builder(100)
                .add(200)
                .multiply(10)
                .print()
                .divideIf(20, (a, b) -> a % 2 == 0)
                .sqrt()
                .print()
                .ceil()
                .build()
    ...
    @Test
    void memoryTest() {
        long result = new MathBuilder.Builder()
                .set(100)
                .sqrt()
                .remember()
                .add(21)
                .recallIf(a -> a < 50, true)
                .mod(2)
                .build()
                .toLong();
    ...
    void freeFallDistance() {
        long distance = new MathBuilder.Builder(9.81)
                .multiply(0.5) // 0.5 * g
                .multiply(5 * 5) // t^2
                .round()
                .build()
    ...
    void batchSalaryProcessing() {
        ...
        for (int i = 0; i < salaries.length; i++) {
            processedSalaries[i] = new MathBuilder.Builder(salaries[i])
                    .addIf(salaries[i] * 0.1, (sal, bonus) -> sal > 2500) // Apply 10% bonus if salary > 2500
                    .multiply(0.92) // Deduct 8% tax
