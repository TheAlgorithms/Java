...
public class UnderstandingShuffleAlgoTest {
    ...
    void testShuffleNullArray() {
        ...
        assertThrows(NullPointerException.class, () -> {
            UnderstandingShuffleAlgo.shuffle(array); // Expect a NullPointerException
        });
    }

    // Test case for an array with duplicate elements
    @Test
    void testShuffleArrayWithDuplicates() {
