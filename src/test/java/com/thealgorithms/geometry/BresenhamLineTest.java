 ...
 * the Bresenham's line algorithm for various input points.</p>
 */
class BresenhamLineTest {
     ...
     * and the expected list of points that should be generated by the
     ...
     * @param expected a list of expected points that should form a line
     */
    @ParameterizedTest
