...
public class RotatingCalipersTest {
    ...
    void testComputeDiameterWithTwoPoints() {
        ...
        assertTrue((result.p1().equals(new Point(0, 0)) && result.p2().equals(new Point(3, 4))) || (result.p1().equals(new Point(3, 4)) && result.p2().equals(new Point(0, 0))));
    }

    @Test
    void testComputeDiameterWithTriangle() {
        List<Point> points = Arrays.asList(new Point(0, 0), new Point(3, 0), new Point(1, 2));
        RotatingCalipers.PointPair result = RotatingCalipers.computeDiameter(points);

        assertNotNull(result);
        assertEquals(3.0, result.distance(), 1e-9);
        assertTrue((result.p1().equals(new Point(0, 0)) && result.p2().equals(new Point(3, 0))) || (result.p1().equals(new Point(3, 0)) && result.p2().equals(new Point(0, 0))));
    }
    ...
    void testComputeDiameterWithRectangle() {
        List<Point> points = Arrays.asList(new Point(0, 0), new Point(4, 0), new Point(4, 2), new Point(0, 2));
        RotatingCalipers.PointPair result = RotatingCalipers.computeDiameter(points);
    ...
    void testComputeDiameterWithPentagon() {
        List<Point> points = Arrays.asList(new Point(0, 0), new Point(2, 0), new Point(3, 1), new Point(1, 2), new Point(-1, 1));
        RotatingCalipers.PointPair result = RotatingCalipers.computeDiameter(points);
    ...
    void testComputeDiameterWithNullPoints() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeDiameter(null); });
    }

    @Test
    void testComputeDiameterWithEmptyPoints() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeDiameter(new ArrayList<>()); });
    }

    @Test
    void testComputeDiameterWithSinglePoint() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeDiameter(Arrays.asList(new Point(0, 0))); });
    }
    ...
    void testComputeWidthWithRectangle() {
        ...
        assertEquals(1.7888543819998317, width, 1e-9); // Correct width for rectangle using rotating calipers
    }

    @Test
    void testComputeWidthWithNullPoints() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeWidth(null); });
    }

    @Test
    void testComputeWidthWithEmptyPoints() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeWidth(new ArrayList<>()); });
    }

    @Test
    void testComputeWidthWithSinglePoint() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeWidth(Arrays.asList(new Point(0, 0))); });
    }
    ...
    void testComputeMinimumAreaBoundingRectangleWithNullPoints() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeMinimumAreaBoundingRectangle(null); });
    }

    @Test
    void testComputeMinimumAreaBoundingRectangleWithEmptyPoints() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeMinimumAreaBoundingRectangle(new ArrayList<>()); });
    }

    @Test
    void testComputeMinimumAreaBoundingRectangleWithSinglePoint() {
        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeMinimumAreaBoundingRectangle(Arrays.asList(new Point(0, 0))); });
    }
    ...
    void testComplexPolygon() {
        ...
        List<Point> points = Arrays.asList(new Point(0, 0), new Point(2, 0), new Point(3, 1), new Point(2, 2), new Point(0, 2), new Point(-1, 1));
    ...
    void testCollinearPoints() {
        ...
        List<Point> points = Arrays.asList(new Point(0, 0), new Point(1, 0), new Point(2, 0), new Point(3, 0));
    ...
    void testSinglePointConvexHull() {
        ...
        List<Point> points = Arrays.asList(new Point(0, 0), new Point(0, 0), new Point(0, 0));

        assertThrows(IllegalArgumentException.class, () -> { RotatingCalipers.computeDiameter(points); });
    }
}
