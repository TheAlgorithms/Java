...
public class BestFitFixedMemoryTest {
    ...
    public void testCaseNumber1(){
        int[] answer = { 47, 48, 125 };
        int[] memory_input = { 25, 48, 59, 55, 47, 125, 236, 458, 659, 789 };
        int[] processes_required_mem = { 27, 28, 66 };

        assertEquals(answer, BestFitFixedMemory.bestFitFixedMemory(3, 10, memory_input, processes_required_mem));
    }
    ...
    public void testCaseNumber2() {
        ...
        assertEquals(answer, BestFitFixedMemory.bestFitFixedMemory(1, 10, memory_input, processes_required_mem));
    }
