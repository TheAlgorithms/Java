...
public class AllPathsFromSourceToTargetTest {
    ...
    void testForFirstCase() {
        ...
        int source = 2;
        int destination = 3;
        List<List<Integer>> list2 = List.of(List.of(0, 2, 1, 3),List.of(2, 0, 3),List.of(2, 1, 3));
    ...
    void testForThirdCase() {
        ...
        int source = 1;
        int destination = 5;
        List<List<Integer>> list2 = List.of(List.of(0, 5),List.of(1, 2, 5));
        List<List<Integer>> list1 = AllPathsFromSourceToTarget.allPathsFromSourceToTarget(vertices,a,source,destination);
        assertIterableEquals(list1, list2);
    }
    ...
    void testForFourthcase() {
        ...
        int source = 0;
        int destination = 2;
        List<List<Integer>> list2 = List.of(List.of(0, 1, 3),List.of(0, 2));
        List<List<Integer>> list1 = AllPathsFromSourceToTarget.allPathsFromSourceToTarget(vertices,a,source,destination);
        assertIterableEquals(list1, list2);
    }
}