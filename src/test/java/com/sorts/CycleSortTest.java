...
public class CycleSortTest {
    ...
    public void cycleSortIntegerTest() {
        ...
        assertArrayEquals(sortedInt, cycleSort.sort(unsortedInt));
        ...
        assertArrayEquals(sortedStr, cycleSort.sort(unsortedStr));
