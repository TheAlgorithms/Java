 ...
 * permutations which are defined by a value given as the indented middle. First
 * permutation: values less than middle. Second permutation: values equal
 * middle. Third permutation: values greater than middle. If no indented middle
 * is given, this implementation will use a value from the given Array. This
 * value is the one positioned in the arrays' middle if the arrays' length is
 * odd. If the arrays' length is even, the value left to the middle will be
 * used. More information and Pseudocode:
