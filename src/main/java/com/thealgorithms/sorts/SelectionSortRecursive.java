...
public class SelectionSortRecursive implements SortAlgorithm {
	...
	/**
	 * Finds the index of the minimum element in the array starting from the given
	 * index.
	 *
	...
	private static <T extends Comparable<T>> int findMinIndex(T[] array, final int start) {
		...
		// Return the index of the smaller element between array[start] and the minimum
