...
/**
 * OddEvenSort class implements the SortAlgorithm interface using the odd-even
 * sort technique. Odd-even sort is a comparison sort related to bubble sort. It
 * operates by comparing all (odd, even)-indexed pairs of adjacent elements in
 * the list and, if a pair is in the wrong order, swapping them. The next step
 * repeats this process for (even, odd)-indexed pairs. This process continues
