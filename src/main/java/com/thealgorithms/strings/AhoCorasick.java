...
public class AhoCorasick {
    ...
    public class Trie {
        ...
        /*
         * For simplification of methods, declared the below as class attributes
         *
        ...
        private ArrayList<ArrayList<Integer>> res; // Stores positions where patterns are found in the text
        private String[] patterns; // patterns according to which Trie is constructed

        /*
         *  Constructor :
         *        -> Builds Trie according to patterns
         *        -> Builds Suffix Links and OutPut Links
         *
         *  @param patterns : patterns according to which Trie is constructed
         */
        public Trie(String[] patterns) {
            ...
            // Build suffix and output links after constructing the trie
        ...
        public ArrayList<ArrayList<Integer>> searchIn(String text) {
            ...
            /*
             * By default res contains end-points.
             * This function converts those endpoints to start points
             */
            for (int i = 0; i < patterns.length; i++) {
    ...
    // Public static method to search for patterns in text
    ...
    // Private static method for converting results to a map
