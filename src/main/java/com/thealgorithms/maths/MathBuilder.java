...
public final class MathBuilder {
    ...
    public static class Builder {
        ...
        public Builder add(double num) {
            if (inParenthesis) sideNumber += num;
            else number += num;
            return this;
        }
        ...
        public Builder toDegrees() {
            if (inParenthesis) sideNumber = Math.toDegrees(sideNumber);
            else number = Math.toDegrees(number);
            return this;
        }

        public Builder max(double num) {
            if (inParenthesis) sideNumber = Math.max(sideNumber, num);
            else number = Math.max(number, num);
            return this;
        }

        public Builder min(double num) {
            if (inParenthesis) sideNumber = Math.min(sideNumber, num);
            else number = Math.min(number, num);
            return this;
        }
        ...
        public Builder pow(double num) {
            if (inParenthesis) sideNumber = Math.pow(sideNumber, num);
            else number = Math.pow(number, num);
            return this;
        }

        public Builder sqrt() {
            if (inParenthesis) sideNumber = Math.sqrt(sideNumber);
            else number = Math.sqrt(number);
            return this;
        }

        public Builder round() {
            if (inParenthesis) sideNumber = Math.round(sideNumber);
            else number = Math.round(number);
            return this;
        }

        public Builder floor() {
            if (inParenthesis) sideNumber = Math.floor(sideNumber);
            else number = Math.floor(number);
            return this;
        }

        public Builder ceil() {
            if (inParenthesis) sideNumber = Math.ceil(sideNumber);
            else number = Math.ceil(number);
            return this;
        }

        public Builder abs() {
            if (inParenthesis) sideNumber = Math.abs(sideNumber);
            else number = Math.abs(number);
            return this;
        }

        public Builder cbrt() {
            if (inParenthesis) sideNumber = Math.cbrt(sideNumber);
            else number = Math.cbrt(number);
            return this;
        }

        public Builder log() {
            if (inParenthesis) sideNumber = Math.log(sideNumber);
            else number = Math.log(number);
            return this;
        }

        public Builder log10() {
            if (inParenthesis) sideNumber = Math.log10(sideNumber);
            else number = Math.log10(number);
            return this;
        }

        public Builder sin() {
            if (inParenthesis) sideNumber = Math.sin(sideNumber);
            else number = Math.sin(number);
            return this;
        }

        public Builder cos() {
            if (inParenthesis) sideNumber = Math.cos(sideNumber);
            else number = Math.cos(number);
            return this;
        }

        public Builder tan() {
            if (inParenthesis) sideNumber = Math.tan(sideNumber);
            else number = Math.tan(number);
            return this;
        }

        public Builder sinh() {
            if (inParenthesis) sideNumber = Math.sinh(sideNumber);
            else number = Math.sinh(number);
            return this;
        }

        public Builder cosh() {
            if (inParenthesis) sideNumber = Math.cosh(sideNumber);
            else number = Math.cosh(number);
            return this;
        }

        public Builder tanh() {
            if (inParenthesis) sideNumber = Math.tanh(sideNumber);
            else number = Math.tanh(number);
            return this;
        }

        public Builder exp() {
            if (inParenthesis) sideNumber = Math.exp(sideNumber);
            else number = Math.exp(number);
            return this;
        }

        public Builder toRadians() {
            if (inParenthesis) sideNumber = Math.toRadians(sideNumber);
            else number = Math.toRadians(number);
            return this;
        }
