...
//	}
	...
	/**
	 * Checks whether a given number is an armstrong number or not. Armstrong number
	 * is a number that is equal to the sum of cubes of its digits for example 0, 1,
	 * 153, 370, 371, 407 etc.
	 *
	 * @param number
	 * @return boolean
